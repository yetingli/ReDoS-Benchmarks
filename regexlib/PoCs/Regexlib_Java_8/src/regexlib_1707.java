...
public class regexlib_1707 {
    ...
    public static void main(String[] args) throws InterruptedException {
        String regex = "(<log4j:Event logger=\")(.*?)(\" timestamp=\")(.*?)(\" level=\")(.*?)(\" thread=\")(.*?)(\">)(.*?)(<log4j:Message><!\\[CDATA\\[)(.*?)(\\]\\]>)";
        for (int i = 0; i < 1000; i++) {
            ...
            // 歧义点
            for (int j = 0; j < i * 1; j++) {
                attackString.append("<log4j:Event logger=\"\" timestamp=\"\" level=\"\" thread=\"");
            }
            // 后缀
