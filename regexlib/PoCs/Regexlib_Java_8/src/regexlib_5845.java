...
public class regexlib_5845 {
    ...
    public static void main(String[] args) throws InterruptedException {
        String regex = "(?<protocol>(http|ftp|https|ftps):\\/\\/)?(?<site>[\\w\\-_\\.]+\\.(?<tld>([0-9]{1,3})|([a-zA-Z]{2,3})|(aero|arpa|asia|coop|info|jobs|mobi|museum|name|travel))+(?<port>:[0-9]+)?\\/?)((?<resource>[\\w\\-\\.,@^%:/~\\+#]*[\\w\\-\\@^%/~\\+#])(?<queryString>(\\?[a-zA-Z0-9\\[\\]\\-\\._+%\\$#\\~\',]*=[a-zA-Z0-9\\[\\]\\-\\._+%\\$#\\~\',]*)+(&[a-zA-Z0-9\\[\\]\\-\\._+%\\$#\\~\',]*=[a-zA-Z0-9\\[\\]\\-\\._+%\\$#\\~\',]*)*)?)?";
