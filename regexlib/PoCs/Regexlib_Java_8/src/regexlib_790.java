...
public class regexlib_790 {
    ...
    public static void main(String[] args) throws InterruptedException {
        String regex = "(SELECT\\s[\\w\\*\\)\\(\\,\\s]+\\sFROM\\s[\\w]+)|(UPDATE\\s[\\w]+\\sSET\\s[\\w\\,\\\'\\=]+)|(INSERT\\sINTO\\s[\\d\\w]+[\\s\\w\\d\\)\\(\\,]*\\sVALUES\\s\\([\\d\\w\\\'\\,\\)]+)|(DELETE\\sFROM\\s[\\d\\w\\\'\\=]+)";
